...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de node.js fundamentos.
...
<head>
  ...
  <title>Aula 28 - Servidor HTTP Básico</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Servidor HTTP Básico</h1>
    <p>Aula 28 - Node.js Fundamentos</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 28');
...
### 2. Commit e Push
```bash
cd exercicios/aula28/
git add .
git commit -m "feat(aula28): servidor http básico"
...
- Título: `[Aula 28] Seu Nome Completo`
