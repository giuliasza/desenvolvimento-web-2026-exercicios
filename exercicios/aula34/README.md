# 📝 Exercício Prático - Aula 34

## 🎯 Objetivo

Criar: **Deploy aplicação**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de deploy e devops.
...
<head>
  ...
  <title>Aula 34 - Deploy aplicação</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Deploy aplicação</h1>
    <p>Aula 34 - Deploy e DevOps</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 34');
...
### 2. Commit e Push
```bash
cd exercicios/aula34/
git add .
git commit -m "feat(aula34): deploy aplicação"
...
- Título: `[Aula 34] Seu Nome Completo`
