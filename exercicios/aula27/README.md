# 📝 Exercício Prático - Aula 27

## 🎯 Objetivo

Criar: **Testes Componentes**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de testing react.
...
<head>
  ...
  <title>Aula 27 - Testes Componentes</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Testes Componentes</h1>
    <p>Aula 27 - Testing React</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 27');
...
### 2. Commit e Push
```bash
cd exercicios/aula27/
git add .
git commit -m "feat(aula27): testes componentes"
...
- Título: `[Aula 27] Seu Nome Completo`
