...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de formulários e validação.
...
<head>
  ...
  <title>Aula 12 - Formulário de Cadastro Completo</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Formulário de Cadastro Completo</h1>
    <p>Aula 12 - Formulários e Validação</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 12');
...
### 2. Commit e Push
```bash
cd exercicios/aula12/
git add .
git commit -m "feat(aula12): formulário de cadastro completo"
...
- Título: `[Aula 12] Seu Nome Completo`
