# 📝 Exercício Prático - Aula 11

## 🎯 Objetivo

Criar: **Galeria de Imagens Interativa**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de dom manipulation.
...
<head>
  ...
  <title>Aula 11 - Galeria de Imagens Interativa</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Galeria de Imagens Interativa</h1>
    <p>Aula 11 - DOM Manipulation</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 11');
...
### 2. Commit e Push
```bash
cd exercicios/aula11/
git add .
git commit -m "feat(aula11): galeria de imagens interativa"
...
- Título: `[Aula 11] Seu Nome Completo`
