...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de state management.
...
<head>
  ...
  <title>Aula 24 - Carrinho de Compras</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Carrinho de Compras</h1>
    <p>Aula 24 - State Management</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 24');
...
### 2. Commit e Push
```bash
cd exercicios/aula24/
git add .
git commit -m "feat(aula24): carrinho de compras"
...
- Título: `[Aula 24] Seu Nome Completo`
