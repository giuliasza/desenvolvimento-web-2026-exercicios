...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de react fundamentos.
...
<head>
  ...
  <title>Aula 21 - Componentes React</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Componentes React</h1>
    <p>Aula 21 - React Fundamentos</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 21');
...
### 2. Commit e Push
```bash
cd exercicios/aula21/
git add .
git commit -m "feat(aula21): componentes react"
...
- Título: `[Aula 21] Seu Nome Completo`
