# 📝 Exercício Prático - Aula 15

## 🎯 Objetivo

Criar: **App de Clima API**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de promises e async/await.
...
<head>
  ...
  <title>Aula 15 - App de Clima API</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>App de Clima API</h1>
    <p>Aula 15 - Promises e Async/Await</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 15');
...
### 2. Commit e Push
```bash
cd exercicios/aula15/
git add .
git commit -m "feat(aula15): app de clima api"
...
- Título: `[Aula 15] Seu Nome Completo`
