# 📝 Exercício Prático - Aula 20

## 🎯 Objetivo

Criar: **Converter JS para TS**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de typescript básico.
...
<head>
  ...
  <title>Aula 20 - Converter JS para TS</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Converter JS para TS</h1>
    <p>Aula 20 - TypeScript Básico</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 20');
...
### 2. Commit e Push
```bash
cd exercicios/aula20/
git add .
git commit -m "feat(aula20): converter js para ts"
...
- Título: `[Aula 20] Seu Nome Completo`
