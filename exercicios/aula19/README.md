# 📝 Exercício Prático - Aula 19

## 🎯 Objetivo

Criar: **Setup projeto moderno**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de webpack e build tools.
...
<head>
  ...
  <title>Aula 19 - Setup projeto moderno</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Setup projeto moderno</h1>
    <p>Aula 19 - Webpack e Build Tools</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 19');
...
### 2. Commit e Push
```bash
cd exercicios/aula19/
git add .
git commit -m "feat(aula19): setup projeto moderno"
...
- Título: `[Aula 19] Seu Nome Completo`
