...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de websockets.
...
<head>
  ...
  <title>Aula 33 - Chat em Tempo Real</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Chat em Tempo Real</h1>
    <p>Aula 33 - WebSockets</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 33');
...
### 2. Commit e Push
```bash
cd exercicios/aula33/
git add .
git commit -m "feat(aula33): chat em tempo real"
...
- Título: `[Aula 33] Seu Nome Completo`
