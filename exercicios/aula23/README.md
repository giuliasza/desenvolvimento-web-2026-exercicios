# 📝 Exercício Prático - Aula 23

## 🎯 Objetivo

Criar: **SPA Multi-página**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de react router.
...
<head>
  ...
  <title>Aula 23 - SPA Multi-página</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>SPA Multi-página</h1>
    <p>Aula 23 - React Router</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 23');
...
### 2. Commit e Push
```bash
cd exercicios/aula23/
git add .
git commit -m "feat(aula23): spa multi-página"
...
- Título: `[Aula 23] Seu Nome Completo`
