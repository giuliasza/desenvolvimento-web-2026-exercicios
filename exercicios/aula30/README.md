...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de mongodb e mongoose.
...
<head>
  ...
  <title>Aula 30 - CRUD MongoDB</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>CRUD MongoDB</h1>
    <p>Aula 30 - MongoDB e Mongoose</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 30');
...
### 2. Commit e Push
```bash
cd exercicios/aula30/
git add .
git commit -m "feat(aula30): crud mongodb"
...
- Título: `[Aula 30] Seu Nome Completo`
