...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de react forms.
...
<head>
  ...
  <title>Aula 25 - Formulário Multi-etapas</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Formulário Multi-etapas</h1>
    <p>Aula 25 - React Forms</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 25');
...
### 2. Commit e Push
```bash
cd exercicios/aula25/
git add .
git commit -m "feat(aula25): formulário multi-etapas"
...
- Título: `[Aula 25] Seu Nome Completo`
