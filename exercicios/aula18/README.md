...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de classes e oop.
...
<head>
  ...
  <title>Aula 18 - Sistema de Biblioteca</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Sistema de Biblioteca</h1>
    <p>Aula 18 - Classes e OOP</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 18');
...
### 2. Commit e Push
```bash
cd exercicios/aula18/
git add .
git commit -m "feat(aula18): sistema de biblioteca"
...
- Título: `[Aula 18] Seu Nome Completo`
