...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de json e apis rest.
...
<head>
  ...
  <title>Aula 16 - CRUD de Usuários</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>CRUD de Usuários</h1>
    <p>Aula 16 - JSON e APIs REST</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 16');
...
### 2. Commit e Push
```bash
cd exercicios/aula16/
git add .
git commit -m "feat(aula16): crud de usuários"
...
- Título: `[Aula 16] Seu Nome Completo`
