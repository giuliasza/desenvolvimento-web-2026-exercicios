...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de es6+ features.
...
<head>
  ...
  <title>Aula 17 - Refatorar código ES6</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Refatorar código ES6</h1>
    <p>Aula 17 - ES6+ Features</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 17');
...
### 2. Commit e Push
```bash
cd exercicios/aula17/
git add .
git commit -m "feat(aula17): refatorar código es6"
...
- Título: `[Aula 17] Seu Nome Completo`
