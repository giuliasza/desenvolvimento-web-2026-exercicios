...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de react hooks.
...
<head>
  ...
  <title>Aula 22 - App com Hooks</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>App com Hooks</h1>
    <p>Aula 22 - React Hooks</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 22');
...
### 2. Commit e Push
```bash
cd exercicios/aula22/
git add .
git commit -m "feat(aula22): app com hooks"
...
- Título: `[Aula 22] Seu Nome Completo`
