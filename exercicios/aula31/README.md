...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de autenticação jwt.
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 31');
...
### 2. Commit e Push
```bash
cd exercicios/aula31/
git add .
git commit -m "feat(aula31): sistema de login"
...
- Título: `[Aula 31] Seu Nome Completo`
