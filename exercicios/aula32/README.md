...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de upload de arquivos.
...
<head>
  ...
  <title>Aula 32 - Upload de Imagens</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Upload de Imagens</h1>
    <p>Aula 32 - Upload de Arquivos</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 32');
...
### 2. Commit e Push
```bash
cd exercicios/aula32/
git add .
git commit -m "feat(aula32): upload de imagens"
...
- Título: `[Aula 32] Seu Nome Completo`
