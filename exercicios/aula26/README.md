...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de styled components.
...
<head>
  ...
  <title>Aula 26 - Sistema de Design</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Sistema de Design</h1>
    <p>Aula 26 - Styled Components</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 26');
...
### 2. Commit e Push
```bash
cd exercicios/aula26/
git add .
git commit -m "feat(aula26): sistema de design"
...
- Título: `[Aula 26] Seu Nome Completo`
