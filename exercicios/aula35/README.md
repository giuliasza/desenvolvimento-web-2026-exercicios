# 📝 Exercício Prático - Aula 35

## 🎯 Objetivo

Criar: **Otimizar aplicação**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de performance e seo.
...
<head>
  ...
  <title>Aula 35 - Otimizar aplicação</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Otimizar aplicação</h1>
    <p>Aula 35 - Performance e SEO</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 35');
...
### 2. Commit e Push
```bash
cd exercicios/aula35/
git add .
git commit -m "feat(aula35): otimizar aplicação"
...
- Título: `[Aula 35] Seu Nome Completo`
