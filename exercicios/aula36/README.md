# 📝 Exercício Prático - Aula 36

## 🎯 Objetivo

Criar: **Aplicação Full Stack Completa**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de projeto final.
...
<head>
  ...
  <title>Aula 36 - Aplicação Full Stack Completa</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Aplicação Full Stack Completa</h1>
    <p>Aula 36 - Projeto Final</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 36');
...
### 2. Commit e Push
```bash
cd exercicios/aula36/
git add .
git commit -m "feat(aula36): aplicação full stack completa"
...
- Título: `[Aula 36] Seu Nome Completo`
