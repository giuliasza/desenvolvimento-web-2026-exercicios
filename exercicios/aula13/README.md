...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de eventos avançados.
...
<head>
  ...
  <title>Aula 13 - Piano Virtual</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>Piano Virtual</h1>
    <p>Aula 13 - Eventos Avançados</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 13');
...
### 2. Commit e Push
```bash
cd exercicios/aula13/
git add .
git commit -m "feat(aula13): piano virtual"
...
- Título: `[Aula 13] Seu Nome Completo`
