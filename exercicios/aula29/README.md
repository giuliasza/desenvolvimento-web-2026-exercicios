# 📝 Exercício Prático - Aula 29

## 🎯 Objetivo

Criar: **API REST Express**
...
Neste exercício você vai desenvolver um projeto completo que demonstra seu domínio dos conceitos de express.js.
...
<head>
  ...
  <title>Aula 29 - API REST Express</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <h1>API REST Express</h1>
    <p>Aula 29 - Express.js</p>
  </header>
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('App iniciado - Aula 29');
...
### 2. Commit e Push
```bash
cd exercicios/aula29/
git add .
git commit -m "feat(aula29): api rest express"
...
- Título: `[Aula 29] Seu Nome Completo`
